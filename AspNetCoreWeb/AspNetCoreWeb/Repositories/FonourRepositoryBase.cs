...
namespace AspNetCoreWeb.Repositories
{
    ...
    public abstract class FonourRepositoryBase<TEntity, TPrimaryKey> 
    ...
    public abstract class FonourRepositoryBase<TEntity> 
        : FonourRepositoryBase<TEntity, Guid> where TEntity : class
    {
